...
resource "aws_cloudwatch_metric_alarm" "example-cpu-alarm-scaleup" {
    ...
    # The alarm will be triggered if the CPU utilization is greater than or equal to the specified threshold.
    comparison_operator = "GreaterThanOrEqualToThreshold"
    # Defines the number of consecutive periods during which (trong đó) the metric must be above the threshold to trigger the alarm
    ...
    #  xác định cụ thể metric nào sẽ được theo dõi và áp dụng alarm lên.
    dimensions = {
